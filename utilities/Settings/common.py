...
def setTitle(_str):
    system = os.name
    if system == 'nt':
        ctypes.windll.kernel32.SetConsoleTitleW(f"{_str}lwur1 tools    |    Made by lwur1   |    Tokenler: [{counttokens}]")
    elif system == 'posix':
        sys.stdout.write(f"{_str}lwur tools    |    Made by lwur1   |    Tokenler: [{counttokens}]")
    else:
        pass
...
.____   __      __ ____ _____________  ____   ________    _______   
|    | /  \    /  \    |   \______   \ \   \ /   /_   |   \   _  \  
|    | \   \/\/   /    |   /|       _/  \   Y   / |   |   /  /_\  \ 
|    |__\        /|    |  / |    |   \   \     /  |   |   \  \_/   \
|_______ \__/\  / |______/  |____|_  /    \___/   |___| /\ \_____  /
        \/    \/                   \/                   \/       \/ 

        discord.gg/0774 - lwur tarafından yapıldı
'''
System.Size(120, 30)
System.Clear()
