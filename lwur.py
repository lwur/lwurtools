...
try:
    ...
    with open('data/logins.json', 'w') as f:
            print(f"\n[{g}#\x1b[95m\x1B[37m] Logging Into ruhsuz")
...
def spammer():
    ...
    Write.Print("                                   | $$| $$ | $$ | $$| $$  | $$ /$$__  $$\n", Colors.purple_to_blue, interval=0.000)
    Write.Print("                                   | $$| $$ | $$ | $$| $$  | $$| $$  \__/\n", Colors.purple_to_blue, interval=0.000)
    Write.Print(f' > [Ruhsuz Toplu Ayarlar]         | $$| $$ | $$ | $$| $$  | $$| $$      \n', Colors.purple_to_blue, interval=0.000)
    Write.Print(f' > [Ruhsuz Team]                  | $$|  $$$$$/$$$$/|  $$$$$$/| $$      \n', Colors.purple_to_blue, interval=0.000)
    Write.Print(" > [lwur1 tarafından geliştirildi] |__/ \_____/\___/  \______/ |__/      \n", Colors.purple_to_blue, interval=0.000)
    Write.Print("════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════", Colors.purple_to_blue, interval=0.000)
    print(f'''{m}'''.replace('$', f'{m}${w}') + f'''
{m}[{w}1{Fore.RESET}{m}]{Fore.RESET} Sunucu Katılma   {b}|{Fore.RESET}{m}[{w}9{Fore.RESET}{m}]{Fore.RESET}  Kanal Spamcısı   {b}|{Fore.RESET}{m}[{w}17{Fore.RESET}{m}]{Fore.RESET} Güncelleme Notları{Fore.RESET}         {b}|{Fore.RESET}{m}[{w}25{Fore.RESET}{m}]{Fore.RESET} Token Üretici{Fore.RESET}
{m}[{w}2{Fore.RESET}{m}]{Fore.RESET} Sunucu Ayrılma   {b}|{Fore.RESET}{m}[{w}10{Fore.RESET}{m}]{Fore.RESET} DM Spamcısı      {b}|{Fore.RESET}{m}[{w}18{Fore.RESET}{m}]{Fore.RESET} Hakkında/Etkinlik{Fore.RESET}      {b}|{Fore.RESET}{m}[{w}26{Fore.RESET}{m}]{Fore.RESET} Nitro Üretici{Fore.RESET}
{m}[{w}3{Fore.RESET}{m}]{Fore.RESET} Token Kontrolü  {b}|{Fore.RESET}{m}[{w}11{Fore.RESET}{m}]{Fore.RESET} Arkadaş Spamcısı  {b}|{Fore.RESET}{m}[{w}19{Fore.RESET}{m}]{Fore.RESET} Sunucu Ara{Fore.RESET}       {b}|{Fore.RESET}{m}[{w}27{Fore.RESET}{m}]{Fore.RESET} QR Token Yakalama{Fore.RESET}
{m}[{w}4{Fore.RESET}{m}]{Fore.RESET} Token Çevrimiçi  {b}|{Fore.RESET}{m}[{w}12{Fore.RESET}{m}]{Fore.RESET} HypeSquad Katılma  {b}|{Fore.RESET}{m}[{w}20{Fore.RESET}{m}]{Fore.RESET} Token Bilgisi{Fore.RESET}    {b}|{Fore.RESET}{m}[{w}28{Fore.RESET}{m}]{Fore.RESET} Üye ID Kazıyıcı{Fore.RESET}
{m}[{w}5{Fore.RESET}{m}]{Fore.RESET} Token Yakalama   {b}|{Fore.RESET}{m}[{w}13{Fore.RESET}{m}]{Fore.RESET} Tepki Spamcısı  {b}|{Fore.RESET}{m}[{w}21{Fore.RESET}{m}]{Fore.RESET} Durum Değiştirici{Fore.RESET}      {b}|{Fore.RESET}{m}[{w}29{Fore.RESET}{m}]{Fore.RESET} PFP Değiştirici{Fore.RESET}
{m}[{w}6{Fore.RESET}{m}]{Fore.RESET} Sunucu MassDM   {b}|{Fore.RESET}{m}[{w}14{Fore.RESET}{m}]{Fore.RESET} Takma Ad Değiştirici  {b}|{Fore.RESET}{m}[{w}22{Fore.RESET}{m}]{Fore.RESET} Grup Spamcısı{Fore.RESET}       {b}|{Fore.RESET}{m}[{w}30{Fore.RESET}{m}]{Fore.RESET} Hakkında{Fore.RESET}
{m}[{w}7{Fore.RESET}{m}]{Fore.RESET} Hesap Patlatıcı {b}|{Fore.RESET}{m}[{w}15{Fore.RESET}{m}]{Fore.RESET} Webhook Spamcısı   {b}|{Fore.RESET}{m}[{w}23{Fore.RESET}{m}]{Fore.RESET} Otomatik Giriş{Fore.RESET}          {b}|{Fore.RESET}{m}[{w}31{Fore.RESET}{m}]{Fore.RESET}{lr} THREADS{Fore.RESET}
{m}[{w}8{Fore.RESET}{m}]{Fore.RESET} Sunucu Patlatıcı  {b}|{Fore.RESET}{m}[{w}16{Fore.RESET}{m}]{Fore.RESET} VC Spamcısı        {b}|{Fore.RESET}{m}[{w}24{Fore.RESET}{m}]{Fore.RESET} DM Silici{Fore.RESET}          {b}|{Fore.RESET}{m}[{w}32{Fore.RESET}{m}]{Fore.RESET}{lr} ÇIKIŞ{Fore.RESET}''')
    Write.Print("════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════", Colors.blue_to_purple, interval=0.000)
    choice = input(f'{m}[{w}>{m}]{w} Seçiminiz?: ')
...
#   JOINER
    if choice == '1':
        ...
        gh = input(f"""
Bu özellik şu anda devredışı.                                   
[\x1b[95m1\x1b[95m\x1B[37m] dev by lwur
[\x1b[95m2\x1b[95m\x1B[37m] Exit
  
[\x1b[95m>\x1b[95m\x1B[37m] Choice?: """)

        if gh in ['01','1']:
            webbrowser.open('https.//discord.gg/0774')
        elif gh in ['02','2']:
            exit = spammer()
        else:
         print('')
...
#   DM SPAMMER
    if choice == '10':
        ...
        gh = input(f"""
DM Spammer is in the Paid Version of GANG-Nuker!\nIf You Are Wanting to Purchase Make Sure to Checkout the Offical dev by lwur!
